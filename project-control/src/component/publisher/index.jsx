...
export default function Publisher() {
    ...
    React.useEffect(() => {
        setLoad2(1)
        React.axios('post', 'http://39.98.41.126:31106/userproject/viewPermission', setLoad2, '',
    ...
    const invite = (id) => {
        if (flag) {
            ...
            setFlag(0)
            React.axios('post', 'http://39.98.41.126:31106/application/releaseApp', setLoad, setFlag,
