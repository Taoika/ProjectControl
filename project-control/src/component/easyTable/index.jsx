...
export default function MyTable(props) {
    ...
    const getResourceData = (props) => {
        setLoad(1)
        React.axios('post', 'http://39.98.41.126:31113/resource/brr', setLoad, '', { projectName: React.getCookie('monitorname') }).then(
            res => {
                // setData(res)
    ...
    const getJsData = () => {
        setLoad(1)
        React.axios('post', 'http://39.98.41.126:31113/jsError/urlErr', setLoad, '', { projectName: React.getCookie('monitorname') }
        ).then(
            res => {
                setData(res)
    ...
    const getApiData = () => {
        setLoad(1)
        React.axios('post', 'http://39.98.41.126:31113/apiError/methodError', setLoad, '', { projectName: React.getCookie('monitorname') }
        ).then(
            res => {
                for (const x of res) {
