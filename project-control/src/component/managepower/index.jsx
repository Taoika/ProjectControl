...
export default function Managepower() {
    ...
    const cancelpower = (userId) => {
        setLoad(1)
        React.axios('post', 'http://106.13.18.48/monitor/userproject/updatePermission', setLoad, '',
            { userId, projectName: React.getCookie('managename') }, '', '', getData)
    }
    const getData = () => {
        setLoad(1)
        React.axios('post', 'http://106.13.18.48/monitor/userproject/viewPermission', setLoad, '',
