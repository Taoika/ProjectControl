...
export default function Managepower() {
    ...
    const cancelpower = (userId) => {
        setLoad(1)
        React.axios('post', 'http://39.98.41.126:31113/userproject/updatePermission', setLoad, '',
            { userId, projectName: React.getCookie('managename') }, '', '', getData)
    }
    const getData = () => {
        setLoad(1)
        React.axios('post', 'http://39.98.41.126:31113/userproject/viewPermission', setLoad, '',
