...
export default function Index() {
    ...
    React.useEffect(() => {
        ...
        React.axios('post', 'http://39.98.41.126:31106/resource/err', setLoad, '', { type: type.toString(), dateType: dateType.toString(), projectName: React.getCookie('monitorname') }).then(
            res => {
                setData(res.reverse())
            },
        )
