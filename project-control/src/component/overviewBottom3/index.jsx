...
export default function Index() {
    ...
    React.useEffect(() => {
        ...
        React.axios('post', 'http://39.98.41.126:31113/performance', setLoad, '', { dateType: dateType.toString(), type: time.toString(), projectName: React.getCookie('monitorname') }).then(
            res => {
                setData(res.reverse())
            },
        )
